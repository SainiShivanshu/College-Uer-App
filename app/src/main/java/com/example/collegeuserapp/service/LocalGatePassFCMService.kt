package com.example.collegeuserapp.service
...
import com.example.collegeuserapp.activity.LocalGatePassListActivity
...
Log.d("FCM", "Message data payload: ${message.data}")
        ...
        val intent = Intent(this,LocalGatePassListActivity::class.java)
